"""
Feature Extractor V2 for Queen AI Neural Network v2.0
...
class FeatureConfigV2:
    """Configuration for V2 feature extraction."""
...
class FeatureExtractorV2:
    """
    Extracts 28 normalized features from V2 observation data.
    ...
    def __init__(self, config: Optional[FeatureConfigV2] = None):

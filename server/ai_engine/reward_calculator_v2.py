"""
Reward Calculator V2 for Queen AI Neural Network v2.0
...
class RewardCalculatorV2:
    """
    Calculates reward signals for Queen NN v2.0 training.

    Compares consecutive observations to determine the effectiveness
    of the Queen's spawn decisions.
    """

    def __init__(self, config: Optional[RewardConfigV2] = None):
        self.config = config or RewardConfigV2()

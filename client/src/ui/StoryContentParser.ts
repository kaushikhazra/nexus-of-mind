...
export class StoryContentParser {
    ...
    public static getPredefinedStoryContent(): StoryContent {
        const pages: StoryPage[] = [
            // Page 1-2: The Empire and the Crisis
            {
            ...
            {
                title: "The Empire and the Crisis",
                content: "But this triumph came at a devastating cost. The energy demands of maintaining their Artificial Consciousness network have pushed their civilization to the brink of collapse. Energy starvation now threatens every aspect of Korenthi life - from the simplest daily tasks to the most complex scientific endeavors.",
                isLastPage: false,
                pageNumber: 2,
                metadata: this.DEFAULT_METADATA
            },
            // Page 3-4: The Discovery
            {
                title: "The Discovery",
            ...
            {
                title: "The Discovery",
                content: "This barren planet harbors a unique mineral unlike anything in their databases - a crystalline substance that their scientists have confirmed to be an extraordinary energy source. The potential is staggering: enough power to restore their civilization and fuel their Artificial Consciousness for millennia.",
                isLastPage: false,
                pageNumber: 4,
                metadata: this.DEFAULT_METADATA
            },
            // Page 5-6: The Challenge
            {
                title: "The Challenge",
            ...
            // Page 7-8: The Energy Lords
            {
                title: "The Energy Lords",
                content: "From this necessity, a new organization was born: The Energy Lords. This elite guild brings together the most skilled remote operators, engineers, and strategists in the Korenthi Empire. You have been selected to join their ranks - an honor that carries both great privilege and tremendous responsibility.",
                isLastPage: false,
                pageNumber: 7,
                metadata: this.DEFAULT_METADATA
            },
            {
                title: "The Energy Lords",
                content: "The Energy Lords have deployed specialized robotic ships capable of establishing complete mining operations on the hostile planet's surface. These vessels can deploy bases, mining drones, and energy generators - all controlled remotely through quantum-linked consciousness interfaces.",
                isLastPage: false,
                pageNumber: 8,
                metadata: this.DEFAULT_METADATA
            },
            // Page 9-10: The Threat
            {
                title: "The Threat",
            ...
            {
                title: "Your Mission",
                content: "While researchers work tirelessly to find a way to neutralize the Queen, the mining operations must continue. The survival of the Korenthi Empire depends on the energy these operations provide.",
                isLastPage: false,
                pageNumber: 12,
                metadata: this.DEFAULT_METADATA
            },
            {
                title: "Your Mission",
                content: "You are now connected to your orbital mining ship, ready to establish operations on this hostile world. Your mission: sustain mineral extraction against an enemy that learns from your every move. The fate of the Korenthi Empire - and their Artificial Consciousness - rests in your hands.",
                isLastPage: false,
                pageNumber: 13,
                metadata: this.DEFAULT_METADATA
            },
            {
                title: "Your Mission",
                content: "Welcome Energy Lord... may the consciousness be with you.",
                isLastPage: true,
                pageNumber: 14,
                metadata: this.DEFAULT_METADATA
            }

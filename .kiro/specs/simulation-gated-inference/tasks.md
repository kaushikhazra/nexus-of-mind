...
- [x] 1. Create simulation module structure
  - [x] 1.1 Create directory structure
    - Directory: `server/ai_engine/simulation/`
    - Files: `__init__.py`, `config.py`
    - _Requirements: 12.1_

  - [x] 1.2 Create SimulationGateConfig dataclass
...
- [x] 2. Implement survival probability component
  - [x] 2.1 Create survival calculation module
  ...
  - [x] 2.2 Implement chunk distance utilities
  ...
  - [x] 2.3 Implement threat factor calculation
...
- [x] 3. Implement worker disruption component
  - [x] 3.1 Create disruption calculation module
  ...
  - [x] 3.2 Implement disruption factor calculation
...
- [x] 4. Implement location penalty component
  - [x] 4.1 Create location penalty module
  ...
  - [x] 4.2 Implement IDLE mode penalty
    - Calculate normalized distance to hive
    - Apply hive_proximity_weight
    - _Requirements: 3.1, 3.2_

  - [x] 4.3 Implement ACTIVE mode penalty
    - Calculate distance to nearest worker
    - Apply worker_proximity_weight
    - _Requirements: 3.1, 3.3_

- [x] 5. Implement spawn capacity validation
  - [x] 5.1 Create capacity validation module
...
- [x] 6. Create combined cost function class
  - [x] 6.1 Create SimulationCostFunction class
  ...
  - [x] 6.2 Implement exploration bonus tracking
    - Track last spawn time per chunk
    - Calculate time-based bonus
    - Apply exploration coefficient
    - _Requirements: 7.1-7.6_

  - [x] 6.3 Add unit tests for cost function
    - File: `server/tests/test_simulation_components.py`
...
- [x] 7. Implement simulation gate
  - [x] 7.1 Create SimulationGate class
...
- [x] 8. Integrate with message handler
  - [x] 8.1 Update message handler for thinking loop
    - File: `server/websocket/message_handler.py`
    - Add SimulationGate instance
    - Evaluate gate before sending spawn decision
    - _Requirements: 6.1-6.5_

  - [x] 8.2 Implement dual training signals
...
- [x] 12. GPU optimization
  - [x] 12.1 Verify PyTorch GPU usage
    - All tensors on CUDA device
    - No CPU-GPU transfers in hot path
    - _Requirements: 10.1-10.3_

  - [x] 12.2 Implement batch processing
...
1. [x] Cost function calculates expected reward matching design formulas
